...
import { LoadingSpinner, PrimaryButton } from '../../shared/components'
...
export default class CreateUser extends Component {
	...
	renderForm = () => {
		...
		return (
			<div className="row">
				<div className="col-md-4 offset-md-4 order-md-1">
					{
						createUserError &&
						<div className="mt-5 mb-5">
							<Alert color="danger">
								There was a problem trying to create the user.
                                <br />
                                Details:
                                <pre>{JSON.stringify(createUserError, null, 2)}</pre>
							</Alert>
						</div>
					}
						...
						render={({
							...
							handleSubmit
								...
								<Form onSubmit={handleSubmit}>
									...
									<PrimaryButton type="submit" text="Create" className="btn-block" />
